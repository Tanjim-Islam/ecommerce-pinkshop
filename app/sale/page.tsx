...
export default function SalePage() {
  ...
  const saleProducts = allProducts.filter((product) => product.discount || product.originalPrice)
  ...
  const saleCategories = Array.from(new Set(saleProducts.map((product) => product.category))).filter(
    Boolean,
  ) as string[]
